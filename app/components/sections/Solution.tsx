      ...
      <Grid>
        <FadeIn className="col-span-2 sm:col-span-4 lg:col-span-2 lg:col-start-1">
          <SolutionPanel
            ...
            overlay={
              <>
                <h2 className="max-w-[14ch] text-4xl leading-[1.05] font-medium tracking-tight text-background">
                  {t.headline}
                </h2>
                <div className="my-6 w-16 border-t border-accent-light" />
                <p className="max-w-[38ch] text-base leading-relaxed text-background/80">
                  {t.supporting}
                </p>
              </>
            }
        ...
        <FadeIn
          delay={0.15}
          className="hidden sm:col-span-4 lg:col-span-3 lg:col-start-4 lg:block lg:self-center"
        >
